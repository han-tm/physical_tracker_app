...
class _FlutterFlowCalendarState extends State<FlutterFlowCalendar> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) => setSelectedDay(selectedRange.start));
  }
        ...
        children: <Widget>[
          CalendarHeader(
            ...
            onLeftChevronTap: () => setState(
              () => focusedDay = widget.weekFormat ? _previousWeek(focusedDay) : _previousMonth(focusedDay),
            ),
            onRightChevronTap: () => setState(
              () => focusedDay = widget.weekFormat ? _nextWeek(focusedDay) : _nextMonth(focusedDay),
            ),
