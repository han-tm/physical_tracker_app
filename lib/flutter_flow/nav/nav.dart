...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: LoginCodePageWidget.routePath,
        ...
        FFRoute(
          name: PolicyTermsPageWidget.routeName,
          path: PolicyTermsPageWidget.routePath,
          builder: (context, params) => PolicyTermsPageWidget(
        ...
        FFRoute(
          ...
          path: LearnGroupPageWidget.routePath,
          builder: (context, params) => LearnGroupPageWidget(
            group: params.getParam<LessonGroupRow>(
              'group',
              ParamType.SupabaseRow,
            ),
            isAll: params.getParam(
              'isAll',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => LearnLessonPageWidget(
            lesson: params.getParam<LessonRow>(
              'lesson',
              ParamType.SupabaseRow,
            ),
          ),
